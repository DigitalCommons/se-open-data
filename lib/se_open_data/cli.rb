...
DOCS
    ...
    desc 'clean', 'Removes all the generated files in the output dierctory'
    long_desc <<DOCS
    ...
    def triplestore
      ...
      begin
        ...
        begin # Parameters for the import process
          ...
          px.pass_id = _opt :pass_id, config.VIRTUOSO_PASS_FILE
      ...
      begin
        ...
        if px.via_dir && px.remove_via_dir
          ...
          if px.via_host
            cmd = ['ssh', '-T', px.via_host, 'rm', '-r', px.via_dir]
...
echo "Number of triplets in graph <#{graph_uri}>: ";
